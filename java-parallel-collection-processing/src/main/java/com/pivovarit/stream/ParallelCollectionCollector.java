...
public class ParallelCollectionCollector<T> implements Collector<Supplier<T>, List<CompletableFuture<T>>, CompletableFuture<List<T>>> {

    private final Executor executor;

    private ParallelCollectionCollector(Executor executor) {
